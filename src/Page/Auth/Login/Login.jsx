    ...
    <div>
      {
        ...
        <div
          className={` w-96 hidden lg:flex absolute ${
            isSignUp ? "lg:-bottom-44  left-0" : " -bottom-20 left-0"
          }`}
        >
          <img src={bg1} alt="" />
        </div>
        <div
          className={`w-80 hidden lg:flex  absolute ${
            isSignUp ? "-bottom-44 right-0" : " -bottom-20 right-0"
          }`}
        >
          <img src={bg2} alt="" />
        </div>
